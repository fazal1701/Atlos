            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="position" placeholder="Point Guard" />
                </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Notifications about discussions and comments</p>
                  </div>
                  <Switch />
                </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Keep your uploaded videos private by default</p>
                  </div>
                  <Switch />
                </div>
          ...
          <TabsContent value="appearance">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Customize how Atlos looks for you</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="space-y-2">
                  <Label>Theme</Label>
